...
public class ProtocolParsing {
    ...
    public static class Key {
        ...
        public static final ProtocolParsing.Key CamAngle = new ProtocolParsing.Key("CA", (byte)28);
        public static final ProtocolParsing.Key ShooterSpeed = new ProtocolParsing.Key("SS", (byte)4);
        public static final ProtocolParsing.Key AnalogValue = new ProtocolParsing.Key("AV", (byte)8);
        public static final ProtocolParsing.Key Position = new ProtocolParsing.Key("DO", (byte)16);
        ...
        public static final ProtocolParsing.Key CANValue = new ProtocolParsing.Key("CV", (byte)20);
        public static final ProtocolParsing.Key DigitalIO = new ProtocolParsing.Key("DI", (byte)0);
        public static final ProtocolParsing.Key[] ALL = { CamAngle, ShooterSpeed, AnalogValue, Position, PWMValue, RelayValue, CANValue, DigitalIO };
    ...
    */
    ...
    public static class FastParser {
        ...
        public static boolean hasArgs(String msg) {
            ...
            if (val == ProtocolParsing.Value.BYTE) { size++; }
            if (val == ProtocolParsing.Value.SHORT) { size += 2; }
            if (val == ProtocolParsing.Value.DOUBLE_BYTE) { size += 2; }
            if (val == ProtocolParsing.Value.DOUBLE_SHORT) { size += 4; }
        ...
        public static String getValue(String msg) throws ParsingException {
            ...
            if (val == ProtocolParsing.Value.BYTE) {
                int num = -1; 
                try { num = msg.charAt(1); } catch (IndexOutOfBoundsException e) { throw new ParsingException(4, "Byte parsing failed"); }
                if (num < 0 || num > 255) { throw new ParsingException(4, "Byte parsing failed: value out of range"); }
                if (isSigned(msg)) {
                    num *= -1;
                }
        ...
        public static String createMessage(ProtocolParsing.Command command, ProtocolParsing.Key key, ProtocolParsing.Value val, String value, String[] args) throws ParsingException {
            ...
            if (command == null) { throw new ParsingException(7, "Command Arguement was set to null"); }
            if (key == null) { throw new ParsingException(7, "Key Arguement was set to null"); }
            if (val == null) { throw new ParsingException(7, "Value Arguement was set to null"); }
            if (value == null) { throw new ParsingException(7, "String value Arguement was set to null"); }
